...
export default {
    data() {
        return {
            ...
            result: "0",
            bufer: "",
            measure: ["Кв. сантиметр (см²)", "Кв. дециметр (дм²)", "Кв. метр (м²)", "Акр", "Гектар (га)", "Кв. километр (км²)"],
            firstSelectedMeasure: 0,
            secondSelectedMeasure: 0,
            m: [
                {
                    name: "Квадратный сантиметр (см²)",
                    value: 0.0001
                },
                {
                    name: "Квадратный дециметр (дм²)",
                    value: 0.01
                },
                {
                    name: "Квадратный метр (м²)",
                    value: 1
                },
                {
                    name: "Акр",
